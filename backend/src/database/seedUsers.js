...
async function seedUsers() {
  ...
  // Não registrar senhas em texto claro nos logs.
  if (criados > 0) {
    console.log(
      `\n[SEED] ${criados} usuário(s) de teste criado(s) (DEVELOPMENT_MODE=true).`,
    );

    console.log(
      "[SEED] As credenciais de teste são definidas apenas neste arquivo e não são exibidas no console.",
    );
